       ...
       <table class="table-fixed w-full" id="DataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2"> <a href="{{route('assigned_paper.show',$paper->number)}}" class="text-primary">{{$paper->number}}</a></td>
                        <td class="border px-4 py-2">{{$paper->template->title}}</td>
                        <td class="border px-4 py-2">{{$paper->creater}}</td>
                        <td class="border px-4 py-2">{{$paper->created_at->format('j F, Y')}}</td>
