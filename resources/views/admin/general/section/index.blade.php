...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <h2 class="font-semibold text-xl text-gray-800 leading-tight my-3">
                Manage sections &nbsp;
                <a href="{{route('admin.sections.create')}}" class="bg-blue-500 hover:bg-blue-700 my-3 px-4 py-2 rounded smal-texxt text-white">Create New </a>
              ...
              <table class="table-fixed w-full" id="DataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="{{route('admin.sections.edit',$section)}}" class="bg-blue-500 fo hover:bg-blue-700 px-4 rounded text-white">Edit</a>
