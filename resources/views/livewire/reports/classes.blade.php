<div>
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
               <h2 class="font-semibold text-xl text-gray-800 leading-tight my-3" > Generate Reports - Class/Section  &nbsp;{{-- <span class="float-right" >Report Period :{{ $filter['start_date']?date_format($filter['start_date'],"d M "):date('d M ') }} - {{ $filter['end_date']?date_format($filter['start_date'],"d M "):'Now' }}</span> --}}</h2>
                <div class="row">
