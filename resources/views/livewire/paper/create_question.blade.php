      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="">
              <div class="mb-4">
                  ...
                  <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Enter Name" wire:model="question">
                  @error('question') <span class="text-red-500">{{ $message }}</span>@enderror

                  <textarea name="editor1" id="t_editor"></textarea>
              </div>
        </div>
      </div>
...
@section('afterScript')
  <script>
                        ClassicEditor
                                .create( document.querySelector( '#t_editor' ) )
                                .then( editor => {
                                        console.log( editor );
                                } )
                                .catch( error => {
