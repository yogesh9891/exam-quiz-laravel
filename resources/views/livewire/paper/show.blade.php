      ...
      <div class="bg-white  sm:p-6 sm:pb-4">
        <div class="row">
            <div class="col-md-12">
                  ...
                  <h1 class="col-md-10 h4"> Paper Title &nbsp;&nbsp; {{$title}}</h1>
                  <h1 class="col-md-10 mt-2 h4"> Paper Number &nbsp;&nbsp; {{$number}}</h1>
             ...
             <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr><th scope="row">ISBN</th><td>{{$isbn}}</td></tr>
                    <tr><th scope="row">Year of Publication</th><td>{{$publication_year}}</td></tr>
                    <tr><th scope="row">Publisher</th><td>{{$publisher}}</td></tr>
                    <tr><th scope="row">Source Chapter Title</th><td>{{$chapter_title}}</td></tr>
                  </tbody>
                </table>

                          <h1 class="col-md-10 mt-2 h4"> Creater &nbsp;&nbsp; {{$paper->creater}}</h1>
                          <h1 class="col-md-10 mt-2 h4"> Created &nbsp;&nbsp; {{$paper->created_at}}</h1>
              ...
              <div class="col-md-4 form-group">
               ...
               <div class="col-md-4 form-group">
                 <label for="exampleFormControlInput2" class="block text-gray-700 text-sm font-bold mb-2">State Board :</label>
                      @if($states)
                  <select wire:model="type" name="state_id" class="form-control" required>
