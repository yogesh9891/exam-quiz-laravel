                         ...
                         <div class="col-md-12">
                          ...
                          <div class="col-md-12 mt-5">
                            ...
                            <h1 class="bg-blue-500 hover:bg-blue-700 mt-3  px-4 py-2 rounded  text-white text-uppercase"> Question :{{$no+1}}. </h1>
                                        ...
                                        <h3 class=" h6 mt-5 p-1 ml-3  border border-dark"><b>{{--  {{$no+1}} --}}{{$lettter}}: {{$que->question}}</h3>
                                          <div class="ml-5">
                                                ...
                                                {{--  <a href="{{route('teacher.question.comment',['number'=>$student_assigned->question_paper_id,'id'=>$que->id])}}" class="btn btn-success">Click here for Comment this question</a> --}}
                                          </div>  
                            ...
                            @if($student_assigned->status =='submit')
                                <div class="col-md-12">
                                        <form action="{{route('teacher.student_paper.show',$student_assigned->id)}}" method="post">
                                         @csrf
                                         <button type="submit" class="btn btn-success" >Paper Checked<button>
                                     </form>
