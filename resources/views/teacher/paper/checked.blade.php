...
<style type="text/css">
  .bg-question {
     background-color: #79ef63 !important;
  }
                    ...
                    <p class="my-3"><b>The student's old answers are  shaded <span class="badge first-question" > grey</span> and the new ones are  in <span class="badge second-question" > purple</span>. All the correct anwsers are shaded <span class="badge bg-question" > green</span>.</b></p>
                             ...
                             <div class="col-md-12 instruction-box ">
                                    ...
                                    <h3 class=" h6 my-2 p-3  "><b>{{$student_assigned->assigned_paper->question_paper->paper->example_heading}}:</b><br>{{$student_assigned->assigned_paper->question_paper->paper->example_decription}}</h3>
                                      ...
                                      @if($student_assigned->student_paper->comment)  <h3 class="h6 my-2 p-3  col-md-12   "style="background-color:#f1b8b8;"><b>General Comment</b> <br>{{ $student_assigned->student_paper->comment }}</h3>
                                      @endif
                                  ...
                                  <div class="col-md-12 p-0">
                                    ...
                                    @endforeach
                                       ...
                                       @if($student_assigned->student_paper->comment2) 
                                       <font color="red">This comment will not be visible to the student.</font>
                                        <h3 class=" h6 my-2 p-3 border border-danger col-md-12 "style="background-color:#ebe169;"><b> Comment Before Archiving</b> <br>{{ $student_assigned->student_paper->comment2 }}</h3>
                                      @endif
                                </div>
