       ...
       <table class="table-fixed w-full" id="table">
                <thead>
                    ...
                    <tr class="bg-gray-100">
                        ...
                        <td class="px-4 py-2 filter" style="widtd:20px;">Archived</td>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="border px-4 py-2">  <a href="{{route('teacher.paper.students',['type'=>'archived','section'=>$sections[0]->section->id??'','question_paper'=>$sections[0]->assigned_paper->id??''])}}" class="btn btn-primary btn-small"> View</a></td> 
