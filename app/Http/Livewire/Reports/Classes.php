...
use App\Exports\Reports\ClassExport;
...
{
	  public $trees,$trunks,$branches,$twiges,$classes,$sections;
      public  $subject_id  ,$category_id ,$branch_id   ,$twig_id ,$class_id ,$section_id ,$start_date ,$end_date;
        public $filter = [
        "tree" => '',
        "trunk" => "",
        "branch" => "",
    ...
    public function updated($name,$value)
{
    ...
    {
        return view('livewire.reports.classes');
    }
        ...
        // $thi->filter['tree'] = null;
         ...
         $students = SchoolStudent::with('user.assigned','user.assigned.assigned_paper.template')->orderBy('created_at','desc');
     ...
     {
           return Excel::download(new ClassExport($this->objects), 'ClassReports.xlsx');
     }
}
